...
User.create(email: "jeff@gmail.com", password: "jeffspassword", name: "Jeffrey", role: student1)
student2 = Student.create
User.create(email: "dana@gmail.com", password: "danaspassword", name: "Dana", role: student2)
...
User.create(email: "msscoop@umd.edu", password: "greatest", name: "Ms.Scoop", role: teacher1)
